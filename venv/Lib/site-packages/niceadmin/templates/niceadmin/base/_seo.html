...
<meta property="og:image" itemprop="image primaryImageOfPage" content="{% static 'img/favicon.png' %}">
...
<link rel="shortcut icon" sizes="16x16 24x24 32x32 48x48" href="{% static 'img/favicon.ico' %}">
